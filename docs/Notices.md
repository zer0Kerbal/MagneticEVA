...
* "MOD-NAME" is trademark of [zer0Kerbal][zedk]
* "ABBV" is trademark of [zer0Kerbal][zedk]
...
* "Magnetic EVA (MEVA)" is a fictitious entity created for entertainment purposes. It is in no way meant to represent a real entity. Any similarity to a real entity is purely coincidental.
